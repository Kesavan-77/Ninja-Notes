        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="my-6 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                ...
                <div class="flex items-center gap-5">
                    <span class="flex items-center gap-2 cursor-pointer" id="like-btn"><p id="like-count"></p><i class="fa fa-thumbs-o-up" aria-hidden="true" height="30px" width="30px"></i><p>like</p></span>
                    <span class="flex items-center gap-2 cursor-pointer"><i class="fa fa-comments-o" aria-hidden="true"></i><p>markdown</p></span>
                </div>
            </div>
        </div>
    </div>
